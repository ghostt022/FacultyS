...
export class DashboardComponent implements OnInit, OnDestroy {
  ...
  private subscribeToNotifications(): void {
    this.notificationSubscription = this.notificationManager.pendingNotifications$.subscribe(
      notifications => {
  ...
  private showNotificationPopup(notification: Notification): void {
    ...
    dialogRef.componentInstance.markAsRead.subscribe((notificationId: string) => {
