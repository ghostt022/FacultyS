        ...
        <div *ngIf="isProfessor" class="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <div class="bg-white rounded-xl shadow p-6">
            ...
            <div class="flex flex-col space-y-3">
              <a routerLink="/dashboard/grades" class="flex items-center p-3 bg-primary-50 hover:bg-primary-100 rounded-lg transition-colors cursor-pointer">
              ...
              <a routerLink="/dashboard/subjects" class="flex items-center p-3 bg-primary-50 hover:bg-primary-100 rounded-lg transition-colors cursor-pointer">
                <span class="material-icons text-primary-600 mr-3">school</span>
                <span class="text-primary-700 font-medium">Мои предмети</span>
              </a>
            </div>
          </div>
